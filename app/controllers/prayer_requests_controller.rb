class PrayerRequestsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prayer_request.save
        format.html { redirect_to :back, notice: 'Prayer request was successfully created.' }
  ...
  private
    ...
    def prayer_request_params
      params.require(:prayer_request).permit(:prayer_id, :prayer_type, :user_id,:name, :description)
    end
end
